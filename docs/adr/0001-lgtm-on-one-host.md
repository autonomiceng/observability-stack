...
traces remain in the stack that produces them; Tempo accepts opt-in OTLP producers.

## Amendment, 2026-09-24

Owner decision: de-privilege the Collector. Alloy no longer embeds cAdvisor, so it runs
